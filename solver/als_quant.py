...
def als(A, W, H, normalize_W = True, method = 'NNLS',
    ...
    if not H is None:
        ...
        logging.debug(["ALS norm", norm1, norm2])

    return W, H, (norm1, norm2)

def als_OSX(A, W, H, normalize_W = True, method = 'NNLS',
        coef_L1W = 0, coef_L2W = 0,
        coef_L1H = 0, coef_L2H = 0,
        omit_norm1 = False,
        fix_W = 0,
    ...
    if not W is None: # update H for W; solve __ Wt * W * H = Wt * A
        ...
        #print H[1, H.shape[1]-1]
        Horg = H
        #if H[1, H.shape[1]-1] < 1000:
        if incrm == 0:
        	H[1, :] = Horg[1, :] + Horg[1, Horg.shape[1]-2]*IntercFac
    ...
    return W, Horg, (norm1, norm2)

def alsWtoH(A, W, H, normalize_W = True, method = 'NNLS',
        coef_L1W = 0, coef_L2W = 0,
        coef_L1H = 0, coef_L2H = 0,
        omit_norm1 = False,
        fix_W = 0,
